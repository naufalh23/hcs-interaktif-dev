...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success("Login berhasil!", {
      description: "Selamat datang di H City CMS.",
    });
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              type="email"
              required
              className="w-full rounded-xl px-4 py-3 text-sm outline-none border-[1.5px]
          ...
          <button
            type="submit"
            disabled={busy}
            className="w-full py-3 rounded-xl bg-gradient-to-br from-[#1B5E35] to-[#2E7D52]
                       text-[#F5F0E8] text-sm font-bold tracking-[2px] uppercase
                       shadow-[0_4px_20px_rgba(27,94,53,0.25)] transition-all
