...
export const HOUSE_TYPES: HouseType[] = [
  {
    ...
    icon: "🏡",
    description:
      "Hunian 1 lantai cocok untuk keluarga muda, desain modern minimalis.",
  ...
  },
  {
    ...
    icon: "🏠",
    description:
      "Hunian dengan tanah luas, area taman belakang ekstra untuk keluarga.",
  ...
  },
  {
    ...
    icon: "🏘",
    description:
      "Hunian 2 lantai dengan 4 kamar tidur, ideal untuk keluarga besar.",
    facilities: [
  ...
  },
  {
    ...
    icon: "🏗",
    description:
      "Tipe baru launching! 2 lantai premium dengan ruang keluarga luas.",
  ...
  },
  {
    ...
    icon: "🏰",
    description:
      "Hunian luas 5 kamar dengan tanah premium dan fasilitas lengkap.",
    facilities: [
      "Taman luas",
      "Carport 3 mobil",
      "Ruang kerja",
  ...
  },
  {
    ...
    icon: "🏯",
    description:
      "Puncak kemewahan H City. Hunian premium terluas dengan 5 kamar ensuite.",
    facilities: [
      "Private garden",
      "Carport 3 mobil",
      "Home office",
