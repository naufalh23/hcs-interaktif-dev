...
export default function SuccessScreen() {
  ...
  return (
    <div
      className="absolute inset-0 flex items-center justify-center overflow-hidden animate-screen-in"
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, rgba(27,94,53,0.08) 1px, transparent 1px)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 65% 55% at 50% 50%, rgba(245,240,232,0.95) 25%, rgba(220,210,188,0.45) 100%)",
        }}
      />
      ...
      {["left-0", "right-0"].map((cls) => (
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg,#163F25,#1B5E35,#2E7D52,#1B5E35,#163F25)",
          }}
        >
          <div
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-130 w-full animate-fade-up">
        ...
        {/* Icon */}
        <div
          className="flex items-center justify-center mt-6 mb-4 animate-pop-in"
          style={{
            width: 88,
            height: 88,
            borderRadius: "50%",
        ...
        {/* Ticket */}
        <div
          className="relative w-full rounded-2xl overflow-visible mb-5"
          style={{
            background: "#FDFAF4",
            border: "1px solid rgba(27,94,53,0.14)",
            boxShadow: "0 8px 40px rgba(27,94,53,0.1)",
          }}
        >
          {/* Notch */}
          <div
          ...
          <div className="px-10 py-6">
            ...
            <div
              style={{
                borderTop: "1.5px dashed rgba(201,168,76,0.3)",
                paddingTop: 14,
              }}
            >
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  <div key={l} className="text-center">
                    ...
                    <div style={{ fontSize: "9.5px", color: "#8A9E8C" }}>
                      {l}
                    </div>
                  </div>
                ))}
              ...
              {total > 0 && (
                <div
                  ...
                  style={{ borderTop: "1px solid rgba(27,94,53,0.1)" }}
                >
                  <div
                    style={{
                      fontSize: "9.5px",
                  ...
                  <div
                    className="font-serif font-bold"
                    style={{ fontSize: "22px", color: "#1B5E35" }}
                  >
                    {formatPrice(total)}
                  </div>
                </div>
        ...
        {/* WA info */}
        <div
          className="w-full rounded-xl px-5 py-3 mb-6 flex items-center gap-2.5"
          style={{
